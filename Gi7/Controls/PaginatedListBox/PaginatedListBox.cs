...
namespace Gi7.Controls.PaginatedListBox
{
        ...
        where T : new()
    {
        ...
        protected static bool useDefaultResult;
        ...
        protected static void _newRequest(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var listBox = (PaginatedListBox<T>) d;
            listBox.SetBinding(ItemsSourceProperty, new Binding(useDefaultResult ? "Request.Result" : "Request.CustomResult")
            {
